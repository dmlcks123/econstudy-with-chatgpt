...
# 크롬 드라이버 설정 (ChromeDriver가 시스템 PATH에 있거나, 실행 파일 경로를 지정)
options = webdriver.ChromeOptions()
options.add_argument('--headless')  # 브라우저 창이 뜨지 않게 설정
...
print(f"찾은 뉴스 기사 수: {len(news_elements)}")
