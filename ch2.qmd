...
1. 선생님 파이썬 데이터 종류에 대해 간단하고 자세하게 설명해주세요
...
::: {.callout-note title="ChatGPT에 질문하기"}
1. 리스트와 튜플의 차이는 무엇이며 용도에 따라 언제 활용하죠?
2. set와 dictionary 차이와 활용법을 소개해주세요
...
4. numpy 배열과 list의 차이는 무엇인가요 어떨때 써- 야 좋은가요
5. 다차원의 배열을 생성한다는 것은 무슨 의미가 있을까요?
6. ambigous?
7. axis조건을 달리하는게 무슨 의미가 있죠?
:::
<br>
...
2. pandas series와 numpy 배열의 차이점은 무엇인가요
:::
<br>
